        ...
        case 'CircleIcon':
            return (
                <svg
                    ...
                    <path fill-rule="evenodd" d="M12 2.5a9.5 9.5 0 100 19 9.5 9.5 0 000-19zM1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12z" /></svg>
            );
        case 'RectangleIcon':
            return (
                <svg
                    ...
                    height="45px"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"><path d="M20 3H4c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM4 19V5h16l.001 14H4z" /></svg>
            );
        case 'TriangleIcon':
            return (
                <svg
        ...
        case 'TextIcon':
            return (
                <svg
                    ...
                    height="45px"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"><path d="M5 8h2V6h3.252L7.68 18H5v2h8v-2h-2.252L13.32 6H17v2h2V4H5z" /></svg>
            );
        default:
            return <svg></svg>;
    }
